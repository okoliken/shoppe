  ...
  <form class="p-4 md:p-0">
    ...
    <div class="mt-[39px]">
      ...
      <div class="flex items-center justify-between mt-10">
        <label class="text-base" for="on-sale">On sale</label>
        <Switch id="on-sale" />
      </div>
      <div class="flex items-center justify-between mt-14">
        <label class="text-base" for="in-stock">In stock</label>
        <Switch id="in-stock" />
      </div>
    </div>
</form>
