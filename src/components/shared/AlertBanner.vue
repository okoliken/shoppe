<template>
  <div
    class="w-full bg-gray-100 py-4 px-6 flex justify-between items-center border-t-2 border-[#A18A68]"
  >
    ...
    <button
      class="text-amber-700 font-medium hover:text-amber-800 cursor-pointer"
      @click="viewCart"
    >
      VIEW CART
    </button>
